            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
                ...
                <div className="mt-4 space-y-4">
                    ...
                    <select
                        ...
                        className="w-full border border-gray-300 rounded p-2 font-normal"
                    >
                        <option value="" disabled>
                            Pilih Category
                        </option>
                        <option className="text-slate-900" value="BadgeBiru">BadgeBiru</option>
                        <option className="text-slate-900" value="BadgeMerah">BadgeMerah</option>
                    </select>
                </div>
