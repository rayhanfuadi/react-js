        ...
        <div className="">
            <div className="" >
                ...
                <div className="flex flex-col px-[12px] mt-3 gap-3 lg:gap-5 lg:px-[24px] lg:mt-6">
                    <h3 className="text-[18px] lg:text-[24px] text-white font-semibold">{tittle}</h3>
                    ...
                    <div className="flex items-center gap-3 lg:gap-5">
                        <div className="font-semibold px-2 py-1 lg:px-4 lg:py-2 bg-slate-700 rounded-full text-[12px] lg:text-[16px] ">
                            13+
                        </div>
                        <p className="px-4 py-1 lg:px-6 lg:py-2 border border-slate-700 rounded-full text-[12px] lg:text-[16px]">16 Episode</p>
                    </div>
                </div>
            </div>
        </div>
