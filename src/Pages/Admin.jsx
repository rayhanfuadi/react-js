...
const Admin = () => {
    ...
    useEffect(() => {
        setTableRows(filmStored)
    }, [filmStored])

    useEffect(() => {
        setProductsRating(filmStored)
    }, [productsRating])
                                                ...
                                                <tr key={id}>
                                                    ...
                                                    <td className={classes}>
                                                        {isEditing ? (
                                                            <input
                                                                type="text"
                                                                value={editedRow.tittle || ""}
                                                                onChange={(e) =>
                                                                    handleInputChange("tittle", e.target.value)
                                                                }
                                                                className="border border-gray-300 rounded p-1 font-normal text-slate-900 w-full"
                                                            />
                                                        ) : (
                                                            <Typography variant="small" className="font-normal text-slate-900">
                                                                {tittle}
                                                    ...
                                                    <td className={classes}>
                                                        <div className="flex gap-4">
                                                            {isEditing ? (
                                                                <>
                                                                    <button
                                                                        className="font-medium text-sm text-white px-4 py-2 bg-green-600 hover:bg-green-700 rounded-md"
