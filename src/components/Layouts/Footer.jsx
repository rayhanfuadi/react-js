const Footer = () => {
    return (
        <div
            className="w-full border-t-[1px] mt-[20px] lg:mt-[40px]  border-[#fff] border-opacity-[0.3]">
            <div className="container py-[20px] lg:py-[60px] lg:flex lg:justify-between bg-primary text-white">
