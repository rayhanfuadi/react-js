const Footer = () => {
    return (
        <div
            className="w-full p-[20px] mt-[28px] lg:mt-[80px] lg:px-[80px] lg:py-[60px] lg:flex lg:justify-between bg-black text-white border-t-[1px] border-[#fff] border-opacity-[0.3]">
