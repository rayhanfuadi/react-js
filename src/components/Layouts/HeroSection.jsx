            ...
            <div
                ...
                <div className="w-full flex justify-between text-white z-30">
                    <div className="flex gap-2">
                        <a className="py-1 px-3 lg:py-2 lg:px-6 flex items-center justify-center bg-blue-600 hover:bg-blue-800 rounded-full font-semibold text-[12px] lg:text-[16px] md:text-[14px]"
                            href="/home">Mulai</a>
                        <a className="py-1 px-3 lg:py-2 lg:px-6 flex items-center justify-center bg-slate-800 hover:bg-slate-900 rounded-full font-semibold text-[12px] lg:text-[16px] md:text-[14px]"
                            href="">Selengkapnya</a>
